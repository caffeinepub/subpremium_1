...
export const Video = IDL.Record({
  ...
  'hlsUrl' : IDL.Opt(IDL.Text),
});
export const VideoUrlRecord = IDL.Record({
  'id' : IDL.Text,
  'owner' : IDL.Principal,
  'ownerName' : IDL.Text,
  'title' : IDL.Text,
...
export const idlService = IDL.Service({
  ...
  'addVideoUrl' : IDL.Func(
      [IDL.Text, IDL.Text, IDL.Text, IDL.Text, IDL.Text, IDL.Opt(IDL.Text)],
      [IDL.Text],
      [],
    ),
  'assignCallerUserRole' : IDL.Func([IDL.Principal, UserRole], [], []),
  'getAllVideoUrlRecords' : IDL.Func([], [IDL.Vec(VideoUrlRecord)], ['query']),
  ...
  'uploadVideo' : IDL.Func(
      [IDL.Text, IDL.Text, ExternalBlob, ExternalBlob, IDL.Text, IDL.Opt(IDL.Text)],
      [IDL.Text],
      [],
    ),
});
...
export const idlFactory = ({ IDL }) => {
  ...
  const VideoUrlRecord = IDL.Record({
    'id' : IDL.Text,
    'owner' : IDL.Principal,
    'ownerName' : IDL.Text,
    'title' : IDL.Text,
