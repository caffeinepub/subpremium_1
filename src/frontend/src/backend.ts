...
export class ExternalBlob {
    ...
    static fromBlob(blob: Blob | File): ExternalBlob {
        const url = URL.createObjectURL(blob);
        const instance = new ExternalBlob(url, null);
        instance._rawBlob = blob;
        return instance;
    }
    public getRawBlob(): Blob | File | null {
        return this._rawBlob ?? null;
    }
...
import type { ExternalBlob as _ExternalBlob, UserProfile as _UserProfile, UserRole as _UserRole, Video as _Video, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addVideoUrl(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string | null): Promise<string> {
        const hlsCandid = arg5 !== null ? [arg5] : [];
        if (this.processError) {
            try {
                const result = await this.actor.addVideoUrl(arg0, arg1, arg2, arg3, arg4, hlsCandid);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllVideoUrlRecords(): Promise<Array<VideoUrlRecord>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllVideoUrlRecords();
                return result.map((r) => ({
                    id: r.id,
                    owner: r.owner,
                    ...
                    videoUrl: r.videoUrl,
                    hlsUrl: r.hlsUrl && r.hlsUrl.length > 0 ? r.hlsUrl[0] : null,
    ...
    async uploadVideo(arg0: string, arg1: string, arg2: ExternalBlob, arg3: ExternalBlob, arg4: string, arg5: string | null): Promise<string> {
        const hlsCandid = arg5 !== null ? [arg5] : [];
        if (this.processError) {
            try {
                const result = await this.actor.uploadVideo(arg0, arg1, await to_candid_ExternalBlob_n18(this._uploadFile, this._downloadFile, arg2), await to_candid_ExternalBlob_n18(this._uploadFile, this._downloadFile, arg3), arg4, hlsCandid);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_opt_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Video]): Promise<Video | null> {
...
async function from_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        video: await from_candid_ExternalBlob_n13(_uploadFile, _downloadFile, value.video),
        owner: value.owner,
        createdAt: value.createdAt,
        description: value.description,
        hlsUrl: value.hlsUrl && value.hlsUrl.length > 0 ? value.hlsUrl[0] : null,
    };
}
